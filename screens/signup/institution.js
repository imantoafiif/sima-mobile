...
const Personal = ({ navigation }) => {
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1, paddingHorizontal: 24, paddingVertical: 27, backgroundColor: 'white', gap: 12 }}>
                ...
                <Text style={styles.title}>Masukkan Data Institusi</Text>
                {/* {
            ...
            <ScrollView>
                <Text style={styles.subtitle}>Masukkan data identitas Anda berdasarkan Institusi atau tempat Anda Bekerja</Text>
                <View style={styles.inputContainer}>
                    <Text style={{ fontWeight: 500 }}>
                        Nama Lengkap <Text style={{ color: '#E81255' }}>*</Text>
                    </Text>
